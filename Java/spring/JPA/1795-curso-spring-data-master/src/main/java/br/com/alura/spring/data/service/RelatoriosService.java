...
public class RelatoriosService {
	...
	public RelatoriosService(FuncionarioRepositoryQueries funcionarioRepositoryQueries) {
	...
	private void buscaFuncionarioNome(Scanner scanner) {
		...
		List<FuncionarioManyToManyOneOwner> list = funcionarioRepositoryQueries.findByNome(nome);
	...
	private void buscaFuncionarioNomeSalarioMaiorData(Scanner scanner) {
		...
		List<FuncionarioManyToManyOneOwner> list = funcionarioRepositoryQueries
	...
	private void buscaFuncionarioDataContratacao(Scanner scanner) {
		...
		List<FuncionarioManyToManyOneOwner> list = funcionarioRepositoryQueries.findDataContratacaoMaior(localDate);
		list.forEach(System.out::println);
	}
	
	private void pesquisafuncionarioSalario() {
		List<FuncionarioProjecao> list = funcionarioRepositoryQueries.findFuncionarioSalario();
