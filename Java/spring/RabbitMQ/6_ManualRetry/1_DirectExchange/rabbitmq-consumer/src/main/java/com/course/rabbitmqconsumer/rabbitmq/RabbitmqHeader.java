...
public class RabbitmqHeader {
	...
	//Esse sera o construtor que vai transformar essa classe em um objeto que represente as partes importantes do
	//header para fazer o retry, o x-death
	@SuppressWarnings("unchecked")
	public RabbitmqHeader(Map<String, Object> headers) {
		if (headers != null) {
			//Aqui vamos ver se esses parametros vieram settados no header
			...
			//o x-death e um campo composto, por isso precisamos ver se cada ele esta presente e cada um dos seus
			//campos precisos para fazer o retry estao presentes
