...
public class JobConfiguration {
	...
	// Escrita flatfile como objetos de json que vimos no 2_
	@Bean
	...
	// Escrita xmlfile que vimos no 3_
	@Bean
	...
	// O CompositeItemWriter permite que nos definamos de uma vez 2 escritores para os arquivos
	// ele define por si só as stremas dos métodos de escrita que passarmos
	// @Bean
	...
	// O ClassifierCompositeItemWriter nos permite criar uma lógica para qual escritor usar na
	// hora de escrever
	@Bean
	...
	public Step step1() throws Exception {
		return stepBuilderFactory.get("step1")
				...
				.writer(itemWriter())
				//Caso usemos o ClassifierCompositeItemWriter, precisamos definir manualmente os streams
