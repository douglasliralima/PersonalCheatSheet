  ...
  render() {
    return (
      <div className="container">
        {/* Aqui dentro nos chamamos o contexto como um componente react e definimos sua função como provider, fazendo isso
        todos os filhos desse componente terão acesso a esse contexto de valor */}
        {/* Ṕodemos passar um valor para sobrepor o valor default que haviamos definido */}
