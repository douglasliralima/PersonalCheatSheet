...
(define (fold-right f val lst)
  (writeln "Chamada de funcao")
  (write val)
  (write lst)
  (writeln "")
    (cond [(empty? lst) val]
          [else (fold-right f (f val (first lst)) (rest lst))])
  )
...
(define (and-lista lst)
  (if (empty? lst)
      #f
      (fold-right (lambda (x y) (and x y)) (first lst) (rest lst))))

(define (or-lista lst)
  (if (empty? lst)
      #t
      (fold-right (lambda (x y) (or x y)) (first lst) (rest lst))))
...
(define (fold-left f val lst)
  ...
  (writeln "")
    (cond [(empty? lst) val]
          [else (f (fold-left f val (rest lst)) (first lst))])
  )
...
(define (concat-lista lista-str)
  (if (empty? lista-str)
      ""
      (fold-right string-append (first lista-str) (rest lista-str))))
